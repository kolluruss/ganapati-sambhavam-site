...
(function () {
  ...
  // matching sarga-<sarga>-shloka-<verse> audio file was actually synced
  // — see tools/build_data.py's audio_filename_candidates. new Audio(src)
  // plays either format based on the file itself, no extension-specific
  // handling needed here. Starting a new verse stops whatever was playing.
